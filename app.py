...
if col2.button("About Us"):
    ...
    col2.markdown("""
    <div style="background-color: #bfe6f2; padding: 10px; border-radius: 5px;">
    <strong>Hanieh Atryan Seresht and Sajjad Farhadi, creators of this web application, present the advancements of our research on heat pipe solar collectors through detailed visualizations. Our objective is to make intricate scientific concepts accessible and visually engaging for a broader audience.</strong>
</div>
    """, unsafe_allow_html=True)
